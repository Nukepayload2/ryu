...
namespace Ryu
{
    partial class Global
    {
        ...
        static ulong[] FLOAT_POW5_INV_SPLIT = new ulong[]{
  ...
  570899077082383953u, 456719261665907162u, 365375409332725730u
        ...
        static ulong[] FLOAT_POW5_SPLIT = new ulong[] {
  ...
  1292469707114105741u, 1615587133892632177u, 2019483917365790221u
        ...
        static bool multipleOfPowerOf2(uint value, uint p)
        {
        ...
        static uint mulShift(uint m, ulong factor, int shift)
        {
            ...
            Debug.Assert(shiftedSum <= uint.MaxValue);
        ...
        static floating_decimal_32 f2d(uint ieeeMantissa, uint ieeeExponent)
        {
            ...
            if (vmIsTrailingZeros || vrIsTrailingZeros)
            {
                ...
                output = vr + Convert.ToUInt32((vr == vm && (!acceptBounds || !vmIsTrailingZeros)) || lastRemovedDigit >= 5);
            }
            else
            {
                ...
                // We need to take vr + 1 if vr is outside bounds or we need to round up.
                output = vr + Convert.ToUInt32(vr == vm || lastRemovedDigit >= 5);
            }
            int exp = e10 + removed;
        ...
        static void f2s_buffered(float f, Span<char> result)
        {
